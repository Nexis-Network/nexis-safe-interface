...
const networks: ChainInfo[] = [
  {
    transactionService: 'https://evm-testnet.nexscan.io/',
    chainId: '2370',
    chainName: 'Nexis Network Testnet',
    shortName: 'nexis',
    l2: false,
    description: 'Nexis Network Testnet (NZT)',
    rpcUri: { authentication: RPC_AUTHENTICATION.API_KEY_PATH, value: 'https://evm-testnet.nexis.network' },
    safeAppsRpcUri: { authentication: RPC_AUTHENTICATION.API_KEY_PATH, value: 'https://evm-testnet.nexis.network' },
    publicRpcUri: { authentication: RPC_AUTHENTICATION.NO_AUTHENTICATION, value: 'https://evm-testnet.nexis.network' },
    blockExplorerUriTemplate: {
      address: 'https://evm-testnet.nexscan.io/account/{address}}',
      txHash: 'https://evm-testnet.nexscan.io/extrinsic/{{txHash}}',
      api: 'https://evm-testnet.nexscan.io/api?module={{module}}&action={{action}}&address={{address}}&apiKey={{apiKey}}',
    },
    nativeCurrency: {
      name: 'Nexis',
      symbol: 'NZT',
      decimals: 18,
      logoUri: 'https://scarlet-hollow-lark-166.mypinata.cloud/ipfs/QmdJwWuMgbhoZhgFM4zWrZne6qs5ktcL1vBLKX12VGgALM',
    },
    theme: { textColor: 'black', backgroundColor: '#10ff84' },
